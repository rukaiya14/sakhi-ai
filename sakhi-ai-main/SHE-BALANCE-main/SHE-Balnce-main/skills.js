...
// AI Chatbot functionality - Redirects to AI Learning Mentor page
let chatMessages = [];

function openAIChatbot() {
    // Redirect to the working AI Learning Mentor page
    window.location.href = 'ai-sakhi/ai-learning-mentor.html';
}
...
function generateCertificate() {
    ...
    const userData = JSON.parse(localStorage.getItem('shebalance_user_data') || '{}');
    const userName = userData.fullName || 'Rukaiya Khan';
