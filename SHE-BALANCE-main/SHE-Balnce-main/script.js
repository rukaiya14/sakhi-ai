...
async function handleLogin(e) {
    ...
    try {
        ...
        // Role-based redirect
        let redirectUrl = 'dashboard.html'; // Default for artisan
        ...
        switch(data.user.role) {
            ...
            case 'buyer':
                ...
                break;
            case 'corporate':
                redirectUrl = 'corporate-dashboard.html';
                break;
            case 'artisan':
            default:
...
function handleSignup(e) {
    ...
    // Validate
    if (!name || !email || !phone || !role || !language || !password) {
    ...
    const existingUsers = ['mariyam@gmail.com', 'admin@shebalance.com', 'buyer@shebalance.com', 'corporate@shebalance.com'];
    if (existingUsers.includes(email.toLowerCase())) {
        alert('This email is already registered. Please login instead.');
        return;
    }

    console.log('✅ SIGNUP SUCCESSFUL for:', name, 'Role:', role);
...
// Open login modal (redirects to login page)
function openLoginModal() {
    console.log('Redirecting to login page');
    window.location.href = 'login.html';
}

// Open signup modal (redirects to login page)
function openSignupModal() {
    console.log('Redirecting to login page for signup');
    window.location.href = 'login.html';
}
...
function showLoginForm() {
    ...
    if (signupFormContainer) signupFormContainer.classList.remove('active');
}
...
function showSignupForm() {
    ...
    if (signupFormContainer) signupFormContainer.classList.add('active');
}
...
function handleGoogleSignIn() {
    ...
    setTimeout(() => {
        ...
        // Store user session
        localStorage.setItem('shebalance_user', JSON.stringify(mockGoogleUser));
    ...
    // Note: In production, you would implement actual Google OAuth:
...
console.log('✅ Enhanced auth modal functions loaded successfully');
